<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <section class="py-4 px-8 bg-white shadow mb-8">
      <h2 class="text-lg font-semibold text-gray-900">Welcome back, {{ username }}!</h2>
    </section>

    <section class="grid grid-cols-3 gap-4 px-8 mb-8">
      <div class="col-span-1 p-6 bg-white shadow rounded">
        <h2 class="text-lg font-semibold text-gray-900">Total Donations</h2>
        <p class="text-4xl font-bold">{{ totalDonations }}</p>
      </div>
      <div class="col-span-1 p-6 bg-white shadow rounded">
        <h2 class="text-lg font-semibold text-gray-900">Total kWh Produced</h2>
        <p class="text-4xl font-bold">{{ totalKwhProduced }}</p>
      </div>
      <div class="col-span-1 p-6 bg-white shadow rounded">
        <h2 class="text-lg font-semibold text-gray-900">Estimated kWh Next 20 Years</h2>
    ...
    <section class="py-4 px-8 bg-white shadow">
      <h2 class="text-lg font-semibold text-gray-900">Community Updates</h2>
      <ul class="mt-4">
